...
use crate::{checkpoints::CheckpointStore, transaction_input_loader::TransactionInputLoader};
...
// };
use crate::messages_consensus::AuthorityCapabilities;
...
use sui_config::node::{DBCheckpointConfig, ExpensiveSafetyCheckConfig, StateDebugDumpConfig};
use sui_config::{genesis::Genesis, node::AuthorityOverloadConfig};
...
use sui_types::base_types::{AuthorityName, ObjectID, ObjectInfo};
...
use sui_types::{
    authenticator_state::get_authenticator_state, execution_config_utils::to_binary_config,
};
use sui_types::{
    base_types::*,
    committee::Committee,
...
use tokio::sync::{mpsc::unbounded_channel, oneshot, RwLock, RwLockWriteGuard};
...
impl AuthorityState {
    ...
    // /// 20240605 TaiVV: Execution layer
    ...
    pub async fn execution_lock_for_reconfiguration(&self) -> RwLockWriteGuard<EpochId> {
    ...
    pub(crate) fn iter_live_object_set_for_testing(
        &self,
    ) -> impl Iterator<Item = super::authority_store_tables::LiveObject> + '_ {
