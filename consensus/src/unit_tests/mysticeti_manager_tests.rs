...
use crate::{
    ...
    consensus_client::LazyMysticetiClient,
    consensus_handler::ConsensusHandlerInitializer,
    consensus_manager::{
        consensus_manager_tests::checkpoint_service_for_testing,
        mysticeti_manager::MysticetiManager, ConsensusManagerMetrics, ConsensusManagerTrait,
    },
    consensus_validator::{SuiTxValidator, TxValidatorMetrics},
};
        ...
        manager
            .start(
                ...
                SuiTxValidator::new(
                    ...
                    TxValidatorMetrics::new(&Registry::new()),
                ),
            )
            .await;
